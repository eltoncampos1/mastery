defmodule Mastery.Boundary.QuizManager do
  ...
  def init(_quizzes), do: {:erorr, "quizzes must be a map"}

  def handle_call({:build_quizz, quiz_fields}, _from, quizzes) do
  ...
  def build_quiz(manager \\ __MODULE__, quiz_fields) do
    GenServer.call(manager, {:build_quizz, quiz_fields})
  end
